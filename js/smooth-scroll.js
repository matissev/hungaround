/* Extracted from http://cferdinandi.github.io/smooth-scroll/
 * To make it work with any container
 */
  ...
  var stopAnimation = function () {
    ...
    if (up) {
     if ( currentLocation == endLocation ) {
      ...
      console.log('scrollHeight', scrollHeight, 'container.innerHeight', container.innerHeight);
      if ( currentLocation == endLocation || ( (container.innerHeight + currentLocation) >= scrollHeight ) ) {
       console.log('stop animation');
       clearInterval(runAnimation);
     }
    }
